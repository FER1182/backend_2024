...
export default class CartsController {
  ...
  async purchaseCart(req, res) {
    try {
      ...
      if (insufficientStockItems.length > 0) {
        ...
        //return res.redirect('/confirmation?message=Algunos productos no tienen stock. Se realizó una parte de la compra, y quedaron estos productos pendientes.');
      ...
      res.redirect('/api/carts/confirmation?message=Compra realizada correctamente.');
  ...
  async confirmation(req, res) {
    try {
      const message = req.query.message || "No se pudo completar la compra.";
      res.render("compraConfirmation", {
